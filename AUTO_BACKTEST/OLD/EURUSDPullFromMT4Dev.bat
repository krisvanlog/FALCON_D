...
set DEST_DIR="C:\Users\Kris\Documents\GitHub\LazyTrade\FALCON_D\ts\EURUSD"
...
set HR=%Hr: =0% 
set HR=%HR: =%
rename "C:\Users\Kris\Documents\GitHub\LazyTrade\FALCON_D\ts\EURUSD\OrdersResultsT2.csv" "EURUSD_%date:~10,4%-%date:~4,2%-%date:~7,2%_%HR%%time:~3,2%.csv" 
